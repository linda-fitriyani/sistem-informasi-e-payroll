                ...
                <form method="post" action="{{ route('article.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-12">
                          <div class="row mt-3">
                            <div class="col-md-12 ">
                              <label for="foto_produk">Banner(*)</label>
                              <div id="foto-dropzone" class="dropzone">Drag & Drop  Foto Banner Produk Disini atau Klik</div>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="summernote"></textarea>
                    ...
                    <div class="d-flex text-center mt-4">
                        ...
                        <button type="submit" class="button-tambah w-100"><i class="bi bi-database-fill-check"></i> Simpan</button>
                    </div>
                </form>
            </div>
        </div>
